    ...
    AuthGuard.prototype.canActivate = function (next) {
        ...
        if (roles) {
            ...
            if (match) {
                ...
                this.alertify.error('You are not authorized to access this segment');
            }
        }
...
var ListsResolver = /** @class */ (function () {
    function ListsResolver(authService, userService, router, alertify) {
        this.authService = authService;
    ...
    ListsResolver = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __metadata("design:paramtypes", [_services_auth_service__WEBPACK_IMPORTED_MODULE_6__["AuthService"], _services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"],
...
/***/ "./src/app/_resolvers/member-lists.resolver.ts":
/*!*****************************************************!*\
  !*** ./src/app/_resolvers/member-lists.resolver.ts ***!
  \*****************************************************/
/*! exports provided: MemberListsResolver */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MemberListsResolver", function() { return MemberListsResolver; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _services_user_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../_services/user.service */ "./src/app/_services/user.service.ts");
/* harmony import */ var _services_alertify_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../_services/alertify.service */ "./src/app/_services/alertify.service.ts");
...
var MemberListsResolver = /** @class */ (function () {
    function MemberListsResolver(userService, router, alertify) {
        this.userService = userService;
        this.router = router;
        this.alertify = alertify;
        this.pageNumber = 1;
    ...
    MemberListsResolver.prototype.resolve = function (route) {
        var _this = this;
    ...
    MemberListsResolver = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __metadata("design:paramtypes", [_services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"],
            _services_alertify_service__WEBPACK_IMPORTED_MODULE_3__["AlertifyService"]])
    ], MemberListsResolver);
    return MemberListsResolver;
}());
...
var MessagesResolver = /** @class */ (function () {
    ...
    MessagesResolver.prototype.resolve = function (route) {
        var _this = this;
        return this.userService.getMessages(this.authService.decodedToken.nameid, this.pageNumber, this.pageSize, this.messageContainer).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function () {
...
var AuthService = /** @class */ (function () {
    function AuthService(http) {
        ...
        this.photoUrl = new rxjs__WEBPACK_IMPORTED_MODULE_5__["BehaviorSubject"]('../..assests/user.png');
...
module.exports = "<div class=\"modal-header\">\n  <h4 class=\"modal-title pull-left\">{{title}}</h4>\n  <button type=\"button\" class=\"close pull-right\" aria-label=\"Close\" (click)=\"bsModalRef.hide()\">\n    <span aria-hidden=\"true\">&times;</span>\n  </button>\n</div>\n<div class=\"modal-body\">\n  <form action=\"\" #rolesForm=\"ngForm\" id=\"rolesForm\">\n    <div class=\"form-check\" *ngFor=\"let role of roles\">\n      <input type=\"checkbox\" \n      class=\"form-ceck-input\" \n      value=\"{{role.name}}\" \n      [checked]=\"role.checked\"\n      (change)=\"role.checked = !role.checked\"\n      [disabled]=\"role.name === 'Admin' && user.userName == 'Admin '\">\n      <label>{{role.name}}</label>\n    </div>\n  </form>\n</div>\n<div class=\"modal-footer\">\n  <button type=\"button\" class=\"btn btn-default\" (click)=\"bsModalRef.hide()\">{{closeBtnName}}</button>\n  <button type=\"button\" class=\"btn btn-success\" (click)=\"updateRoles()\" form=\"rolesFrom\">Submit</button>\n</div>\n`"
...
var UserManagementComponent = /** @class */ (function () {
    ...
    UserManagementComponent.prototype.editRolesModal = function (user) {
        ...
        this.bsModalRef.content.updateSelectedRoles.subscribe(function (values) {
            var rolesToUpdate = {
                rolesName: values.filter(function (el) { return el.checked === true; }).map(function (el) { return el.name; }).slice()
            };
            if (rolesToUpdate) {
                _this.adminService.updateUserRoles(user, rolesToUpdate).subscribe(function () {
                    user.roles = rolesToUpdate.rolesName.slice();
                }, function (error) {
                    console.log(error);
                });
            }
...
/* harmony import */ var _home_register_register_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./home/register/register.component */ "./src/app/home/register/register.component.ts");
...
/* harmony import */ var _resolvers_member_lists_resolver__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./_resolvers/member-lists.resolver */ "./src/app/_resolvers/member-lists.resolver.ts");
...
/* harmony import */ var time_ago_pipe__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! time-ago-pipe */ "./node_modules/time-ago-pipe/esm5/time-ago-pipe.js");
...
/* harmony import */ var _admin_admin_panel_admin_panel_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./admin/admin-panel/admin-panel.component */ "./src/app/admin/admin-panel/admin-panel.component.ts");
/* harmony import */ var _directives_hasRole_directive__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./directives/hasRole.directive */ "./src/app/directives/hasRole.directive.ts");
/* harmony import */ var _admin_user_management_user_management_component__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./admin/user-management/user-management.component */ "./src/app/admin/user-management/user-management.component.ts");
/* harmony import */ var _admin_photo_management_photo_management_component__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./admin/photo-management/photo-management.component */ "./src/app/admin/photo-management/photo-management.component.ts");
/* harmony import */ var _services_admin_service__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! ./_services/admin.service */ "./src/app/_services/admin.service.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _home_register_register_component__WEBPACK_IMPORTED_MODULE_15__["RegisterComponent"],
                ...
                _admin_admin_panel_admin_panel_component__WEBPACK_IMPORTED_MODULE_36__["AdminPanelComponent"],
                _directives_hasRole_directive__WEBPACK_IMPORTED_MODULE_37__["HasRoleDirective"],
                _admin_user_management_user_management_component__WEBPACK_IMPORTED_MODULE_38__["UserManagementComponent"],
                _admin_photo_management_photo_management_component__WEBPACK_IMPORTED_MODULE_39__["PhotoManagementComponent"],
            ...
            providers: [
                ...
                _resolvers_member_lists_resolver__WEBPACK_IMPORTED_MODULE_27__["MemberListsResolver"],
                ...
                _services_admin_service__WEBPACK_IMPORTED_MODULE_40__["AdminService"]
            ],
            bootstrap: [
                _app_component__WEBPACK_IMPORTED_MODULE_11__["AppComponent"]
            ]
...
module.exports = "<div class=\"bg\">\n  <div class=\"container mt-5\">\n      <div  *ngIf=\"!registerMode\" style=\"text-align: center\">\n        <h1>Find your match</h1>\n        <p class=\"lead\">Come on in to view your possible matches... All you need to do is sign up!</p>\n        <div class=\"text-center\">\n          <button class=\"btn btn-primary btn-lg mr-2\" (click)=\"registerToggle()\">Register</button>\n          <button class=\"btn btn-info btn-lg\">Learn more</button>\n        </div>\n      </div>\n    \n      <div *ngIf=\"registerMode\" class=\"container\">\n        <div class=\"row justify-content-center\">\n          <div class=\"col-4\">\n            <app-register (cancelRegister)=\"cancelRegisterMode($event)\"></app-register>\n          </div>\n        </div>\n      </div>\n    </div>\n</div>\n"
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"], _services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])
    ], HomeComponent);
...
var ListsComponent = /** @class */ (function () {
    ...
    ListsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"], _services_user_service__WEBPACK_IMPORTED_MODULE_1__["UserService"],
...
module.exports = "<div class=\"card mb-4\">\n  <div class=\"card-img-wrapper\">\n    <img src=\"{{user.photoUrl || '../../../assets/user.png'}}\" alt=\"{{user.knownAs}}\" class=\"card-img-top\">\n    <ul class=\"list-inline member-icons animate text-center\">\n      <li class=\"list-inline-item\">\n        <button class=\"btn btn-primary\" [routerLink]=\"['/members', user.id]\"><i class=\"fa fa-user\"></i></button>\n      </li>\n      <li class=\"list-inline-item\">\n        <button class=\"btn btn-primary\"><i class=\"fa fa-heart\" (click)=\"sendLike(user.id)\"></i></button>\n      </li>\n      <li class=\"list-inline-item\">\n        <button class=\"btn btn-primary\"><i class=\"fa fa-envelope\" [routerLink]=\"['/members/', user.id]\" [queryParams]=\"{tab:3}\"></i></button>\n      </li>\n    </ul>\n  </div>\n  <div class=\"card-body p-1\">\n    <h6 class=\"card-title txt-center mb-1\"><i class=\"fa fa-user\"></i>\n    {{user.knownAs}}, {{user.age}}</h6>\n    <p class=\"card-text text-muted text-center\">{{user.city}}</p> \n  </div>\n</div>"
...
var MemberCardComponent = /** @class */ (function () {
    function MemberCardComponent(authService, userService, alertifyServie) {
        this.authService = authService;
        this.userService = userService;
        this.alertifyServie = alertifyServie;
    }
    ...
    MemberCardComponent.prototype.sendLike = function (id) {
        ...
        this.userService.sendLike(this.authService.decodedToken.nameid, id).subscribe(function (data) {
            _this.alertifyServie.success('You have liked: ' + _this.user.knownAs);
        }, function (error) {
            _this.alertifyServie.error(error);
        });
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
...
var MemberDetailComponent = /** @class */ (function () {
    ...
    MemberDetailComponent.prototype.selectTable = function (tabId) {
...
var MemberEditComponent = /** @class */ (function () {
    ...
    MemberEditComponent.prototype.unloadNotificvation = function ($event) {
    ...
    MemberEditComponent.prototype.updateUser = function () {
        ...
        this.userService.updateUser(this.authService.decodedToken.nameid, this.user).subscribe(function (next) {
            ...
            _this.alertify.error('an error occurred');
        });
    };
    ...
    ], MemberEditComponent.prototype, "unloadNotificvation", null);
...
var PhotoEditorComponent = /** @class */ (function () {
    ...
    PhotoEditorComponent.prototype.deletePhoto = function (id) {
        var _this = this;
        this.alertify.confirm('Do you really want to delete this photo ?', function () {
...
var NavComponent = /** @class */ (function () {
    ...
    NavComponent.prototype.login = function () {
        ...
        this.authService.login(this.model).subscribe(function (next) {
            ...
            _this.alertify.error('error occured');
        }, function () {
            _this.router.navigate(['/members']);
        });
    };
...
/* harmony import */ var _resolvers_member_lists_resolver__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./_resolvers/member-lists.resolver */ "./src/app/_resolvers/member-lists.resolver.ts");
...
var appRoutes = [
    ...
    { path: '', redirectTo: 'home', pathMatch: 'full' },
    {
        ...
        children: [
            { path: 'members', component: _members_member_list_member_list_component__WEBPACK_IMPORTED_MODULE_1__["MemberListComponent"], resolve: { users: _resolvers_member_lists_resolver__WEBPACK_IMPORTED_MODULE_7__["MemberListsResolver"] } },
            ...
            { path: 'lists', component: _lists_lists_component__WEBPACK_IMPORTED_MODULE_3__["ListsComponent"], resolve: { users: _resolvers_list_resolver__WEBPACK_IMPORTED_MODULE_11__["ListsResolver"] } },
...
module.exports = __webpack_require__(/*! C:\Users\joshua.akosa\Desktop\DatingApp\DatingApp-SPA\src\main.ts */"./src/main.ts");
